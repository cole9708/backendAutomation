...
with open('C:\\Users\\cole9\\PycharmProjects\\BackEndAutomation\\courses.json') as f:
    data = json.load(f)
    print(data)
    print(type(data))
...
with open('C:\\Users\\cole9\\PycharmProjects\\BackEndAutomation\\courses.json') as fi:
    data2 =  json.load(fi)
    assert data == data2
